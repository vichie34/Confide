    ...
    <div>
      ...
      <header className="bg-white shadow-md">
        <div className="container mx-auto px-4 py-8 flex justify-between items-center">
          ...
          <button
            className="bg-gradient-to-r from-orange-500 via-red-500 to-orange-600 text-white px-4 py-2 rounded-full text-sm font-bold hover:bg-orange-600 cursor-pointer transition-colors"
            ...
            {!isMobile && (
              <div className="flex flex-col items-center space-y-4">
                <p className="text-sm text-gray-600">
                  Scan this QR code with your phone to open the correct app
                  store.
                </p>
                <img
                  src={
