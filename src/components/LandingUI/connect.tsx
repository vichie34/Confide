const features = [
  {
    ...
    description:
      'Connect with like-minded individuals in our engaging chat rooms. Join discussions that matter to you.',
  ...
  },
  {
    title: 'Wallet System',
    description:
      'Securely manage your transactions with our integrated wallet system. Easy-to-use digital features for a seamless experience.',
  ...
  },
  {
    title: 'Wellbeing Hub',
    description:
      'Learn about the practices required to maintain optimal wellbeing. Access resources and expert guidance.',
  ...
  },
  {
    ...
    description:
      'Connect with certified wellness guides and practitioners. Get personalized support for your journey.',
...
function Connect() {
  ...
  const ANDROID_URL =
    'https://play.google.com/store/apps/details?id=com.confidecommunity.app';
  const IOS_URL =
    'https://apps.apple.com/us/app/confide-join-our-community/id6503924952';
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mt-16 text-center h-319px bg-gradient-to-r from-[#FDECD4] to-[#f5f5f5] py-12 px-4 rounded-[30px]">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Ready to start your journey of meaningful connections and community?
            Join today and experience the power of authentic connections.
          </p>
          <button
            type="button"
            className="bg-gradient-to-r from-orange-500 via-red-500 to-orange-600 text-white px-8 py-3 rounded-full font-medium hover:bg-orange-600 transition-colors duration-200"
        ...
        <div className="fixed inset-0 bg-gradient-to-r from-[#FDECD4] to-[#f5f5f5] bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-gradient-to-r from-[#f5f5f5] to-[#FDECD4] rounded-lg shadow-lg p-6 w-md">
            ...
            <p className="text-gray-700 mb-6">
              Scan this QR code with your phone to open the correct app store.
            </p>
            <div className="flex flex-col items-center space-y-4">
              <img
                src={
                  typeof window !== 'undefined'
                    ? `https://api.qrserver.com/v1/create-qr-code/?size=220x220&data=${encodeURIComponent(window.location.origin + '/get-app.html')}`
                    : '/assets/confide_logo_dark.png'
                }
